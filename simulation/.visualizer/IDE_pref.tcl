...
set perspective_DateTime   {2025-08-03T23:43:53}
set perspective_Directory  {D:/1-Work/3-Digital_Design_Kareem_Wassem/2-Final_Projects/Project_1_DSP48A1}
...
pref::set -type string -category General -name IDEVisibleWindows -value Lint###zinlintMsgView,transcript,zinflownavigator,zinlintDesignMetricsView,zinlintDesignInfoView,zinlintMsgDashboardView,source,zincdcdutview,zinlintMsgStatusHistoryView,zinmsgviewer,zinlintMsgSummaryView -hide -description none -label none
